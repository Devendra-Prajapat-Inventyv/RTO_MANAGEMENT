...
<head>
    ...
    <title>RTO User : Dashboard</title>
...
$sql="SELECT tblnewsbyoffice.ID, tblnewsbyoffice.OfficerID,tblnewsbyoffice.Title,tblnewsbyoffice.Description,tblnewsbyoffice.CreationDate from tblnewsbyoffice 
";
$query = $dbh -> prepare($sql);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
