...
$ret="select Email from tblofficer where Email=:email || MobileNumber=:mobnum || EmpID=:empid";
...
$sql="insert into tblofficer(EmpID,FirstName,LastName,MobileNumber,Email,Gender,Dob,Religion,Address,Password,ProfilePic)values(:empid,:fname,:lname,:mobnum,:email,:gender,:dob,:religion,:address,:password,:propic)";
...
$query->bindParam(':propic',$propic,PDO::PARAM_STR);
 $query->execute();
   ...
   if ($LastInsertId>0) {
    echo '<script>alert("Officer detail has been added.")</script>';
echo "<script>window.location.href ='add-officer.php'</script>";
  }
  else
    {
...
<head>
    ...
    <title>RTO : Add Officer Information </title>
                                ...
                                <div class="col-md-3">
                                    <div class="basic-form">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control  bg-ash"  name="dob" required="true">
