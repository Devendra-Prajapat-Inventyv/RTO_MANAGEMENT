...
$eid=$_GET['editid'];
$sql="update tblofficer set FirstName=:fname,LastName=:lname,MobileNumber=:mobnum,Email=:email,Gender=:gender,Dob=:dob,Address=:address where tblofficer.ID=:eid";
...
$query->bindParam(':eid',$eid,PDO::PARAM_STR);
 $query->execute();
    ...
    echo '<script>alert("Officer detail has been updated.")</script>';
...
<head>
    ...
    <title>RTO : Update Officer Information </title>
                        ...
                        <div class="page-header">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class="active">Officer Information</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card alert">
                        <div class="card-body">
                            <form name="" method="post" action="" enctype="multipart/form-data">
                                <?php
                                    $eid=$_GET['editid'];
$sql="SELECT tblofficer.ID,tblofficer.EmpID,tblofficer.FirstName,tblofficer.LastName,tblofficer.MobileNumber,tblofficer.Email,
tblofficer.Gender,tblofficer.Dob,tblofficer.Address,tblofficer.Password,tblofficer.ProfilePic,
tblofficer.JoiningDate from tblofficer  where tblofficer.ID=$eid";
$query = $dbh -> prepare($sql);
$query->execute();
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="basic-form">
                                        <div class="form-group">
                                            <label>Address</label>
                                            <input type="text" class="form-control bg-ash"  name="address" required="true" value="<?php  echo htmlentities($row->Address);?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                ...
                                <div class="col-md-12">
                                    <div class="basic-form">
                                        <div class="form-group image-type">
                                            <label> Officer Photo <span>(150 X 150)</span></label>
