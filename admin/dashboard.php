...
$sql3 ="SELECT * from  tblofficer";
$query3 = $dbh -> prepare($sql3);
$query3->execute();
$results3=$query3->fetchAll(PDO::FETCH_OBJ);
$totofficer=$query3->rowCount();
?>
                                       <h4 style="color: blue">Total Officer</h4>
                                         <h4 style="color: blue"><?php echo htmlentities($totofficer);?></h4>
                                         <a href="manage-officer.php"><h5>View Detail</h5></a>
                                    </div>
                                </div>
                            </div>
                        </div>
