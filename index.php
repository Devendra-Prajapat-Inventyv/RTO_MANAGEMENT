			...
			<header>
				...
				<div class="header-bottom-w3layouts">
					<div class="main-w3ls-logo">
						<h1><a href="index.php"><span class="fa fa-road" aria-hidden="true"></span>RTO MANAGEMENT</a></h1>
					</div>
					<!-- navigation -->
					...
					<span class="icon-bar"></span>
						...
						<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
							<ul class="nav navbar-nav">
								...
								<li><a href="rto_office/login.php">Officer</a></li>
...
<div class="testimonials-section">
		<div class="container">
			<h5 class="main-w3l-title">Notice By RTO</h5>
...
{               ?>
	...
	<div class="footer-agileits-w3layouts">
		<div class="container">
			<div class="btm-logo-w3ls">
				<h2><a href="index.html"><span class="fa fa-taxi" aria-hidden="true"></span>RTO</a></h2>
			</div>
			<div class="clearfix"> </div>
		</div>
	</div>
	<div class="copyright-w3layouts">
		<div class="container">
			<p style="font-size:15px">&copy; 2022 RTO . Road transport Authority Gujrat  </p>
		</div>
	</div>
	<!-- //Footer -->
