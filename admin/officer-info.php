...
<head>
    ...
    <title>RTO : Officer Details</title>
                        ...
                        <div class="page-header">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class="active">Officer Details</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-12">
                            <div class="card alert">
                                ...
                                <div class="card-body">
                                    <?php
                                    $eid=$_GET['editid'];
$sql="SELECT tblofficer.ID,tblofficer.EmpID,tblofficer.FirstName,tblofficer.LastName,tblofficer.MobileNumber,tblofficer.Email,tblofficer.Religion,tblofficer.Gender,
tblofficer.Dob,tblofficer.Address,tblofficer.Password,tblofficer.ProfilePic,tblofficer.JoiningDate 
from tblofficer  where tblofficer.ID=$eid";
...
<?php
  ...
  {
    $sql="Delete * from tblofficer where ID=$eid";
    $query = $dbh -> prepare($sql);
    $query->execute();
    echo "successfully";
  }
...
<button><a href="edit-officer-info.php?editid=<?php echo htmlentities ($row->ID);?>"><i class="ti-pencil-alt"></i></a> </button>
...
<div class="birthday-content">
 ...
 <span class="contact-title">Religion:</span>
    <span class="religion"><?php  echo htmlentities($row->Religion);?> </span>
 </div>
