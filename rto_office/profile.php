...
$sql="SELECT tblofficer.ID,tblofficer.EmpID,
tblofficer.FirstName,tblofficer.LastName,tblofficer.MobileNumber,
tblofficer.Email,tblofficer.Gender,tblofficer.Dob,tblofficer.Religion,
tblofficer.Address,tblofficer.Password,tblofficer.ProfilePic,tblofficer.JoiningDate 
from tblofficer where tblofficer.ID=$tid";
