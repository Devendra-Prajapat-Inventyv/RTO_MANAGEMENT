...
$sql="insert into tblnewsbyoffice(OfficerID,Title,Description)values(:tid,:title,:desc)";
...
$sql="delete from tblnewsbyoffice where ID=:rid";
$query=$dbh->prepare($sql);
...
<head>
    ...
    <title>RTO : News or Announcement</title>
