...
<?php include_once('includes/sidebar.php');?>
        ...
        <div class="main">
            <div class="container-fluid">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-2">
                            <img src="../images/main.png" class="img-fluid" style="height:150px"> 
                        </div>
                       <div class="col">
                    ...
                    <div class="row">
                     <div class="col-sm-2">
                          ...
                          <div class="col-sm-8" style="text-align: center; padding-bottom: 0px;">
                              <h3><b><u>Driving Licence</u></b></h3><hr>
                        </div>
                        <div class="col-sm-2">
                        </div>
                    </div>
   ...
   <div class="col-4">
      ...
      <label class="lable">Licence No</label>
    </div>
     <div class="col-8">
     <h4> <?php echo $row['licenceno']; ?>
    </div>
    </div>
...
<div class="form-group row">
  ...
  <div class="row">
   ...
   <div style="width: 150px; ">
      <img src="uploads/<?php echo $row['image']; ?> "  width="150" height="200"><br><br>
