            ...
            <div class="container-fluid">
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <h3><b>Learning Licence Form</b></h3>
                        </div>
                        <div class="col-sm-2">
                        </div>
                    </div>
...
if(isset($_POST['submit']))
{
    ...
    $fees="2500";
    $status="Pending";
    $applicationnumber='APPGJ'.rand(99,2).time();
    $folder="uploads/";
    //Photo
    ...
    $sql="Insert into tblllicence(applicationnumber,fullname,fathername,gender,mobile,email,dob,image,city,state,address,licencetype,sign,pay_status,fees,status)
    Values(:applicationnumber,:fullname,:fathername,:gender,:mobile,:email,:dob,:image,:city,:state,:address,:licencetype,:sign,:pay_status,:fees,:status)";
    ...
    $stmt->bindparam(':licencetype',$licencetype,PDO::PARAM_STR);
...
if($lastInsertId)
{
    ...
    echo "<script>alert('You have successfully Submited with us $applicationnumber');</script>";
